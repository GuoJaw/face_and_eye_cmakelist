...
void MainWindow::on_SSD_Detect_clicked()
{
    ...
    /*
    string model_file_classifer   = "../model/GuoJawee/deploy.prototxt";  //prototxt
    string trained_file_classifer = "../model/GuoJawee/GuoJaweeNet_iter_500.caffemodel";  //caffemodel
    string mean_file_classifer    = "../model/GuoJawee/mean.binaryproto";  //均值文件
    string label_file_classifer   = "../model/GuoJawee/labels.txt";  //标签文件：labels.txt
    */
    //
